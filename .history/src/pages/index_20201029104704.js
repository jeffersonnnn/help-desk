...
import OvalTwo from "../components/images/oval"
import OvalThree from "../components/images/oval"
import OvalFour from "../components/images/oval"
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-4 my-4">
            ...
            <p className="text-center">Join our dev forums to discuss plugins and third party integration.</p>
          </div>
          <div className="col-md-4 my-4">
            <div className="sectionthree-img mx-auto">
              <Examples />
            ...
            <p className="text-center">Explore some sample plugins built by the Remita Team.</p>
          </div>
          <div className="col-md-4 my-4">
            <div className="sectionthree-img mx-auto">
              <Support />
            ...
            <p className="text-center">Reach our to us at devsupport@remita.net</p>
          </div> 
        </div>
      </div>
    </div>   
