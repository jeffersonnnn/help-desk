      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4 my-4">
            ...
            {/* <p className="text-center sectionthree-body">Reach out to us at devsupport@remita.net</p> */}
            <a className="text-center sectionthree-body" href={"mailto:" + "devsupport@remita.net"}>Reach out to us at devsupport@remita.net</a>
