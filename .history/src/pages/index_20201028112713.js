    ...
    <div className="container">
      <div className="row my-5">
        <div className="col-md-4">
          <div className="card gridcard h-100">
            <div className="card-body">
              ...
              <div class="row">
                <p className="card-text col-8 gridcard-text text-center">
        ...
        <div className="col-md-4">
          <div className="card gridcard h-100">
            <div className="card-body">
              <h5 className="card-title gridcard-title text-center">Funds Transfer</h5>
              <p className="card-text gridcard-text text-center">
        ...
        <div className="col-md-4">
          <div className="card gridcard h-100">
            <div className="card-body">
              <h5 className="card-title gridcard-title text-center">Reference Data Services</h5>
              <p className="card-text gridcard-text text-center">
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4 my-4">
            ...
            <p>Explore some sample plugins built by the Remita Team.</p>
          </div>
          <div className="col-md-4 my-4">
            <div className="sectionthree-img mx-auto">
              <Support />
            ...
            <p>Reach our to us at devsupport@remita.net</p>
          </div> 
        </div>
      </div>
    </div>   
