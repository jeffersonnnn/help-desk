      ...
      <div className="container">
        <div className="row">
          <div className="col-md-4 my-4">
            ...
            <h4 className="my-4 text-center section-divide__text">Developer Community</h4>
          ...
          <div className="col-md-4 my-4">
            ...
            <h4 className="my-4 text-center section-divide__text">Examples</h4>
          ...
          <div className="col-md-4 my-4">
            ...
            <h4 className="my-4 text-center section-divide__text">Support</h4>
