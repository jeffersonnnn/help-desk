    ...
    <div className="container">
      ...
      <div className="row">       
        <div className="col-md-6 col-sm-12">
          <h1 className="">Build and Integrate your payment products and solutions</h1>
        </div>       
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4 my-4">
            ...
            <p className="text-center sectionthree-body">Reach our to us at devsupport@remita.net</p>
          </div> 
        </div>
      </div>
    </div>   
