      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4 my-4">
            ...
            <p className="text-center sectionthree-text">Explore some sample plugins built by the Remita Team.</p>
          </div>
          <div className="col-md-4 my-4">
            <div className="sectionthree-img mx-auto">
              <Support />
            ...
            <p className="text-center sectionthree-text">Reach our to us at devsupport@remita.net</p>
          </div> 
        </div>
      </div>
    </div>   
